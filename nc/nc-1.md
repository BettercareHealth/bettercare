...
[fig-1-1]: {{ site.baseurl }}/images/fig-1-1.svg "The important steps in basic newborn resuscitation"
[fig-1-A]: {{ site.baseurl }}/images/fig-1-A.svg "The Apgar scoring sheet"
[fig-1-B]: {{ site.baseurl }}/images/fig-1-B.svg "The position of the head during mask ventilation"
[fig-1-C]: {{ site.baseurl }}/images/fig-1-C.svg "A bag and mask for resuscitation"
[fig-1-D]: {{ site.baseurl }}/images/fig-1-D.svg "An endotracheal tube with an introducer in place"
[fig-1-E]: {{ site.baseurl }}/images/fig-1-E.svg "A laryngoscope with a small, straight blade"
[fig-1-F]: {{ site.baseurl }}/images/fig-1-F.svg "The blade of the laryngoscope on the tongue"
[fig-1-G]: {{ site.baseurl }}/images/fig-1-G.svg "A view of the epiglottis"
[fig-1-H]: {{ site.baseurl }}/images/fig-1-H.svg "The laryngoscope is lifted upwards to see the vocal cords. Note that the tip of the blade is in the hollow just before the epiglottis"
[fig-1-I]: {{ site.baseurl }}/images/fig-1-I.svg "View of the larynx"
[fig-1-J]: {{ site.baseurl }}/images/fig-1-J.svg "Introducing the endotracheal tube"
[fig-1-K]: {{ site.baseurl }}/images/fig-1-K.svg "The position of the hands when giving chest compressions"