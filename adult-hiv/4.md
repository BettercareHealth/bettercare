...
1.	Patients who are on the old first line regimen of d4t, 3TC and efavirenz or nevirapine may be changed to a fixed dose combination tablet of TDF, FTC and efavirenz if they have side effects due to d4t (lipoatrophy) or at high risk of developing side effects (high BMI or pregnant)
...
ABC (generic name abacavir) is also a ‘nuc’ (trade name is Viagen). ABC 300mg (1 tablet) should be taken every 12 hours. ABC is usually used if a patient cannot take TDF, AZT or d4T. ABC is well-tolerated though there is a small risk of a severe initial hypersensitivity reaction.
