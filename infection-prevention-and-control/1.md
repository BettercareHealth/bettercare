...
|                                                                 |                |                     |                 |
| **Practice category**                                           | Non-compliant  | Partially compliant | Fully compliant |
|                                                                 | 0              | 1                   | 2               |
| **Environmental cleaning**                                      |                |                     |                 |
|                                                                 |                |                     |                 |
| 1. There is a written policy for general cleaning of the ward   |                |                     | x               |
| 2. Cleaning equipment is appropriately stored on the ward       | x              |                     |                 |
| 3. All cleaning staff are trained in IPC                        |                |                     | x               |
|                                                                 |                |                     |                 |
| **Hand Hygiene**                                                |                |                     |                 |
|                                                                 |                |                     |                 |
| 1. Running water is available at all hand-wash basins           |                | x                   |                 |
| 2. Soap is available at all handwash basins                     |                | x                   |                 |
| 3. Paper towels are available at all hand-wash basins           | x              |                     |                 |
|                                                                 |                |                     |                 |
| **Tally the scores**                                            | 0              | 2                   | 4               |
|                                                                 |                |                     |                 |
| **SUB-TOTAL SCORE**                                             |                |                     |                 |
|                                                                 |                |                     |                 |
| **Actual score of 6 out of possible score of 12 = 50%**         |                |                     |                 |
|-----------------------------------------------------------------+----------------+---------------------+-----------------|
...
*	Date of the report and the names of parties involved in drafting the report.
	...
	*	Molecular analysis techniques (PCR sequencing) were used to determine if the bacterial isolates were related.
	...
	4.	Hand hygiene compliance in the neonatal unit should be re-inforced.
	...
	Sr N Khumalo (IPC practitioner), Dr M Smith (Microbiology), Dr G Sithole (Neonatal Unit)
