...
The fingertips, thumbs and little finger are commonly missed areas when performing hand hygiene. The correct technique for handwashing should be demonstrated to all new healthcare workers and re-inforced for existing staff through the use of hand hygiene posters (available from the WHO website). 
...
![Figure 4-3: How to handwash](images/4-3.svg)

Figure 4-3: How to handwash
{:.figure-caption}
