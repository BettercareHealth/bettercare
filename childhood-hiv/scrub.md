...
During labour the mother is also given a single dose of TDF plus FTC (emtricitabine) to reduce the risk of her developing resistance to nevirapine.
...
Again at 10, 14 weeks and nine months for immunisation.
...
Clinical (clinical staging)

Immunological (CD4 count)

Social (home and family circumstances)
...
All children aged 5 years and younger should be started on antiretroviral treatment even if the CD4 percentage is normal.

Children over 5 years of age: a CD4 count on or below 350 cells/μl
...
**The first screening visit** (often called the week 2 visit). This visit is usually the parent and child’s first contact with the staff of the antiretroviral clinic.

**The second screening visit** (often called the week 1 visit). The first and second visits are used to prepare and assess whether the parent/care giver is ready for the treatment to start.
...
Check that the diagnosis of HIV infection is correct by measuring the viral load.

Make sure that the clinical and immunological criteria for antiretroviral treatment have been met.
...
Exclude tuberculosis. This requires a careful history including TB contacts, a chest X-ray, sputum examination and Mantoux skin test.

Assess whether there has been good adherence with co-trimoxazole prophylaxis. Count the tablets or measure the volume of medication remaining in the bottle.

Take blood for baseline investigations: a full blood count or Hb, and ALT if nevirapine is to be used..
...
The baseline CD4 percentage is usually done before the patient is referred for treatment consideration and, therefore, need not be repeated. If the CD4 percentage was not measured, this should be done.

A baseline viral load should also be done.

Blood should be taken for baseline full blood count. Serum ALT (alanine transaminase) should also be measured if nevirapine is to be used.
...
Get the baseline blood results and the screenings tests for TB (sputum examination and Mantoux skin test).
...
Assess whether the co-trimoxazole medication has been taken correctly.
...
An assessment of the co-trimoxazole medication is done once more to assess adherence (compliance).
...
Take blood for a full blood count (if on AZT) and ALT (if on nevirapine). These results must be reviewed and the child recalled if they are abnormal.
...
A full blood count should be done at one, two and three months, and then annually, for children on AZT.

Repeat ALT in children on nevirapine only if rash of jaundice appears.
...
Take blood for CD4 percentage or count and viral load.
...
Children aged one to five years have a sustained CD4 percentage of 25% or more.

Children aged six years or more have a sustained CD4 percentage of 25% or more or a CD4 count of 250 cells/µl.

Children started on antiretroviral treatment soon after birth should remain on co-trimoxazole prophylaxis.
...
It is important to make sure that the adherence with co-trimoxazole treatment is excellent before starting antiretroviral treatment.
...
There is concern that nevirapine used in the prevention of mother-to-child transmission (PMTCT) may cause drug resistance to both nevirapine and efavirenz in mother or infant. This may limit the success of future antiretroviral treatment.
...
The development of new signs or recurrent signs of stage 3 or 4 HIV infection.

Development of immunodeficiency with a CD4 percentage below 10 or a CD4 count below 200 cells/mm³ in a child aged 2 to 5 years or a CD4 count below 100 cells/ mm³ in a child of 5 years or older. An abnormal CD4 percentage or count should always be confirmed by a repeat measurement.

The presence of a detectable or increasing viral load suggests that the HIV infection is not being controlled. This is the most accurate measure of treatment failure.
...
Drug resistance (infection with a drug-resistant HI virus causes treatment failure from the start)
...
Two similar drugs compete with each other at their site of action. For example, nevirapine and efavirenz should not be used together.
...
If two drugs have similar side effects, these side effects are more likely to occur and be severe if the two drugs are used together. For example, both nevirapine and co-trimoxazole may cause skin rashes.
...
Rifampicin causes some problems with ‘non-nucs’ and lowers blood level of these drugs, especially nevirapine. Efavirenz is less affected than nevirapine, therefore nevirapine is often changed to efavirenz when first-line antiretroviral treatment is being given at the same time as anti-TB treatment. The dose of efavirenz need not be changed.
...
Hidden or mild infections which have been missed clinically. An example would be silent TB.

Worsen existing infections. An example would be TB which has only been treated for a few weeks.
...
Practical reminders are important. An alarm clock, radio or TV programme or cell phone message may be helpful.
...
Infections which are **also seen in children who are not infected with HIV**:
...
Infections which are **uncommon in children who are not infected with HIV**:
...
Infections which are **rare in children who are not infected with HIV**.
...
Chronic diarrhoea: This may complicate acute diarrhoea or be due to unusual organism such as Cryptosporidium or Isosporia. Lactose intolerance may complicate chronic diarrhoea.
...
Severe, recurrent or chronic pneumonia caused by bacteria that also cause pneumonia in children who do not have HIV infection, e.g. Streptococcal pneumonia (Pneumococcus) and *Haemophilus influenza* B.
...
Chest X-ray will usually show broncho­pneumonia, enlarged lymph nodes, a pleural effusion or miliary TB. However, the chest X-ray may appear normal. Other pulmonary infections, such as bacterial and viral pneumonias, may be confused with tuberculosis.

A stained smear of sputum or gastric aspirate may show TB bacilli. However, the smear may be negative. Induced coughing is the best method of obtaining a sputum sample.
...
If the CD4 count is less than 15% or 200 cells/µl or the child very ill (stage 4) antiretroviral treatment should be started earlier. An exception is children with TB meningitis who should be started on TB treatment for at least two weeks before starting antiretroviral treatment.
...
If nevirapine is being used, it should be replaced with efavirenz, which is less affected by rifampicin.
...
Cerebral toxoplasmosis, cryptococcal meningitis, CMV retinitis and progressive multifocal leucoencephalopathy (PML) are uncommon in children.
...
For mild pain: Paracetamol (Panado) and ibuprofen (Brufen). The dose of paracetamol is 60 to 120 mg for children under one year, 120 to 250 mg to children from one to five years and 250 to 500 mg for older children. Syrup contains 120 mg/5 ml while tablets are 500 mg each. The dose of ibuprofen is 20 mg/kg/day in divided doses. Paracetamol and ibuprofen should be given every four to six hours as required. Aspirin must be avoided.

For moderate pain: Codeine phosphate 30 to 60 mg every four hours. Often paracetamol or ibuprofen are used in addition.

For severe pain: Oral morphine solution starting at 5 to 10 mg every four hours.
