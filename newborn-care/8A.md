...
Accutrend test strips can also be read by eye but are best used with an Accutrend, Accutrend Plus or Glucotrend monitor. The method of using the strips and the monitor are given in the package insert.
