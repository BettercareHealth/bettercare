...
![Figure 2-A: The Ballard scoring method](images/2-A.svg)

Figure 2-A: The Ballard scoring method
{:.figure-caption}

![Figure 2-B: Weight for gestational age chart](images/2-B.svg)
{:.half-page}

Figure 2-B: Weight for gestational age chart
{:.figure-caption}

![Figure 2-C: Head circumference for gestational age chart](images/2-C.svg)
{:.half-page}
