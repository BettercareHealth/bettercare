...
Note
:	By convention the cut off of 2.5 mmol/l for seum is used for both whole blood and serum.
...
1. In most infants at high risk of hypogly­caemia, the blood glucose concentration should be measured hourly for the first 3 hours, then 2 hourly for the next 3 hours. Thereafter the blood glucose should be monitored every 3 hours until 100 ml/kg/day milk feeds have been established which is usually in 24 to 48 hours.
...
{% include youtube-start.html %}MieKJa5YJd4{% include youtube-end.html %}
