...
<a href="#live-test" id="live-test-show" class="button non-printing" onclick="showHide('live-test');">Open test</a>

<div id="live-test" class="live-test non-printing">
	<a id="restart-test" href="#" class="button non-printing" onclick="location.reload(true)">Start again</a>
	<div class="loading">
		<iframe class="autoHeight" src="http://form.myjotform.com/form/43496817304561"></iframe>
	</div><!--.loading-->
	<a id="restart-test" href="#" class="button non-printing" onclick="location.reload(true)">Start again</a>
...
<figure>
	<img src="images/fig-1-1.svg" alt="Figure 1-1: The important steps in basic newborn resuscitation.">	
