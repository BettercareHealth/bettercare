...
![Figure 5-A: an example of a chart used for the routine observations of sick infants](images/5-A.svg)
...
![Figure 5-B: An example of an intake and output chart](images/5-B.svg)
