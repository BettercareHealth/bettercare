...
![Figure 1-A: The position of the head during mask ventilation](images/fig-1-A.svg)

Figure 1-A: The position of the head during mask ventilation
{:.figure-caption}
...
![Figure 1-B: A bag and mask for resuscitation](images/fig-1-B.svg)
{:.half-page}

Figure 1-B: A bag and mask for resuscitation
{:.figure-caption}

![Figure 1-C: An endotracheal tube with an introducer in place](images/fig-1-C.svg)
{:.half-page}

Figure 1-C: An endotracheal tube with an introducer in place
{:.figure-caption}

![Figure 1-D: A laryngoscope with a small, straight blade](images/fig-1-D.svg)
{:.half-page}

Figure 1-D: A laryngoscope with a small, straight blade
{:.figure-caption}

![Figure 1-E: The blade of the laryngoscope on the tongue](images/fig-1-E.svg)
{:.half-page}

Figure 1-E: The blade of the laryngoscope on the tongue
{:.figure-caption}

![Figure 1-F: A view of the epiglottis](images/fig-1-F.svg)
{:.half-page}

Figure 1-F: A view of the epiglottis
{:.figure-caption}

![Figure 1-G: The laryngoscope is lifted upwards to see the vocal cords. Note that the tip of the blade is in the hollow just before the epiglottis.](images/fig-1-G.svg)
{:.half-page}

Figure 1-G: The laryngoscope is lifted upwards to see the vocal cords. Note that the tip of the blade is in the hollow just before the epiglottis.
{:.figure-caption}

![Figure 1-H: View of the larynx.](images/fig-1-H.svg)
{:.half-page}

Figure 1-H: View of the larynx.
{:.figure-caption}

![Figure 1-I: Introducing the endotracheal tube.](images/fig-1-I.svg)
{:.half-page}

Figure 1-I: Introducing the endotracheal tube.
{:.figure-caption}
...
![Figure 1-J: The position of the hands when giving chest compressions.](images/fig-1-J.svg)

Figure 1-J: The position of the hands when giving chest compressions.
{:.figure-caption}
