...
Mortality rates are usually expressed per 1000 or 100â€¯000 individuals (i.e. as a proportion). For example, the mortality rate for newborn infants is usually given per 1000 infants delivered alive while the mortality rate for pregnant women is usually given per 100â€¯000 pregnant women who deliver.
...
While it is important to identify and prevent problems which kill patients, it is also important to address problems, which cause illness without death. To get a complete view of problems in a health service, both mortality and morbidity must be considered. Because morbidity is far commoner that mortality, deaths are only the â€˜tip of the icebergâ€™. By studying morbidity, it is possible to get a better idea of the pattern of disease or incorrect management which results in mortality. Where deaths are uncommon, it is particularly useful to study patterns of morbidity. The causes and avoidable factors of mortality and morbidity are usually the same.
...
Note
:	The HIV positive rate is becoming a very important measure of the spread of the disease in each community and each womanâ€™s HIV status may also be included in the register, provided that the result is kept strictly confidential.

### 1-32 What useful information can be calculated from information in a birth register?

1.	Teenage pregnancy rate.
2.	Rate of attending antenatal care (â€˜booking rateâ€™).
3.	Syphilis rate.
...
> A low rate of syphilis sceening indicates poor antenatal care.
...
A high rate of infants â€˜born before arrivalâ€™ (BBA) indicates poor communications and transport services.
...
\begin{align*}
\[
\frac{\textrm {Number of infants weighing less than 2500 g at birth}}{\textrm {Total number of infants delivered}}\times 100
\]
\end{align*}
$$
...
At a regular monthly perinatal mortality meeting in a regional hospital, the inforÂ­mation from the birth register is used to present an audit of maternal and perinatal care provided. Important items from the minimal data set are discussed.
