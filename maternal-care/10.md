...
{% include jotform-start.html %}51552282200544{% include jotform-end.html %}
...
In practice there are very few indications for the use of sedatives in labour. If a patient is restless or distressed, it is almost always because of pain and she therefore needs analgesia. The tranquillising effect of promethazine (Phenergan) or hydroxyzine (Aterax) together with pethidine will provide sufficient sedation for a restless patient. The dose is 25 mg promethazine (Phenergan) and 100 mg hydroxyzine (Aterax).
