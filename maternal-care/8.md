...
{% include jotform-start.html %}51552195789569{% include jotform-end.html %}
...
Firstly, the patient should be reassured and given analgesia with pethidine and promethazine (Phenergan) or hydroxyzine (Aterax). Then an oxytocin infusion should be started to make the contractions more effective.
