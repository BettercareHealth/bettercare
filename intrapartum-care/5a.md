...
*   Allows the physiological process of contraction + retraction of the myometrium
...
*   Implementing the emergency measures (Unit 5, section 11-28) for postpartum haemorrhage.
...
Note
:   TThe Ellavi intrauterine balloon could be used to temporise blood loss prior to taking the patient to theatre for an evacuation.
...
If patient is to be transferred, close the T-valve for the duration of the journey.
...
*   Height markings for pressures of 80, 100, 120, 140 and 160 mmHg are indicated on the tubing (See below).
