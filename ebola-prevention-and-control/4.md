...
{% include jotform-start.html %}50073035710543{% include jotform-end.html %}
...
![Figure 4-2: [% chlorine in liquid bleach/% chlorine desired] - 1 = total parts water for each part bleach*](images/4-2.svg)

Example: To make a 0.5% chlorine solution from 3.5%** bleach:

![Figure 4-3: [3.5%/0.5%] - 1 = 7 – 1 = 6 parts water for each part bleach](images/4-3.svg)
...
![Figure 4-4: [% chlorine desired/% chlorine in bleach powder] x 1000 = grams of bleach powder for every litre of water](images/4-4.svg)

Example: To make a 0.5% chlorine solution from calcium hypochlorite (bleach) powder containing 35% active chlorine:

![Figure 4-5: [0.5%/35%] x 1000 = 0.0143 x 1000 = 14.3](images/4-5.svg)
...
![Figure 4-6: Total Parts (TP) (H2O) = [% Concentrate/% Dilute] - 1](images/4-6.svg)

Example: To make a dilute solution (0.1%) from 5% concentrated solution

![Figure 4-7: Calculate TP (H2O) = [5%/0.1%] - 1 = 50 – 1 = 49](images/4-7.svg)
